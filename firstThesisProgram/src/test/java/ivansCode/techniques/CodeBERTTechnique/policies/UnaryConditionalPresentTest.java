...
class UnaryConditionalPresentTest extends BaseTestClass {
    ...
    void testSimpleExpression(){
        ...
        String code = "class A { boolean c = true; void m() { boolean d = !c; } }";
        ...
        try (
            ...
            CodeBERTTechnique technique = new CodeBERTTechnique(code, originalClassName,
                    List.of(new UnaryConditionalPresent()));
        ...
        Set<String> expectedResults = Set.of(
                "class A { boolean c = true; void m() { boolean d = c; } }"
        );
